            ...
            <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12  bg-gray-400  text-white">
                <div className="flex flex-col items-center w-full">
                    ...
                    <div className="flex flex-col w-full">
                        <textarea rows="3" placeholder="Message..." className="p-4 rounded-md resize-none  text-white  bg-gray-500"></textarea>
                        <button type="button" className="py-4 my-8 font-semibold rounded-md  text-black  bg-violet-400">Leave feedback</button>
                    </div>
                </div>
