            ...
            <div className="w-full max-w-sm p-6 m-auto mx-auto  rounded-lg shadow-md bg-white-800 text-black">
                <form onSubmit={handleSubmit} className="mt-6">
                    <div>
                        ...
                        <input onChange={handleInput} name='email' id='email' type="email" className="block w-full px-4 py-2 mt-2 font-semibold border rounded-lg  text-black border-gray-600  focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>

                    <div className="mt-4">
                        <div className="flex items-center justify-between">
                            <label htmlFor="password" className="block text-sm  text-black">Password</label>
                            <Link onClick={handleForgetPassword} to="" className="text-xs  text-black hover:underline">Forget Password?</Link>
                        </div>

                        <input onChange={handleInput} name='password' type="password" className="block w-full px-4 py-2 mt-2   border rounded-lg  text-black border-gray-600  focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <Link to="#" className="text-xs text-center  uppercase text-gray-400 hover:underline">
                ...
                <div className="flex items-center mt-6 -mx-2">
                    <button type="button" className="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:bg-blue-400 focus:outline-none">
                        ...
                        <span onClick={handleGooglelogin} className="hidden mx-2 sm:inline">Sign in with Google</span>
                    </button>
                ...
                <p className="mt-8 text-xs font-light text-center text-black"> Don't have an account? <Link onClick={() => { handleToggle(true) }} to="#" className="font-medium  text-black hover:underline">Create One</Link></p>
            </div>
        </div>
    );
};
